...
/**
 * A Material 3 color picker showing only the Hue x Saturation Spectrum pad: the 2D picking
 * area, a Saturation (brightness) slider, an optional Opacity slider, the selected-color
